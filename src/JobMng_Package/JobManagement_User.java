...
import HomePage_Package.UserHome;
 ...
 */
public class JobManagement_User extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("job assignment");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(combo_emp, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel16.setText("job submission");
                    ...
                    .addGroup(panel_job_submissionLayout.createSequentialGroup()
                        ...
                        .addGroup(panel_job_submissionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(panel_job_submissionLayout.createSequentialGroup()
                                ...
                                .addGap(60, 60, 60)))
                        .addGroup(panel_job_submissionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(jScrollPane6, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(panel_job_submissionLayout.createSequentialGroup()
                        .addGap(414, 414, 414)
        ...
        panel_job_submissionLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_job_submissionLayout.createSequentialGroup()
                ...
                .addGroup(panel_job_submissionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_job_submissionLayout.createSequentialGroup()
                        .addGroup(panel_job_submissionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jScrollPane7, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_job_submissionLayout.createSequentialGroup()
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JobManagement_User.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JobManagement_User().setVisible(true);
            }
        });
    }
...
public void loadTableEmp() {
    ...
    try{
       ...
       //     String regNo = rs1.getString("job_details.reg_no");
        //    String v_type = rs1.getString("job_details.v_type");
            String jid = rs1.getString("jid");
            String j_type = rs1.getString("jid");
            String eid = rs1.getString("eid");
    ...
    // String sql2 = "select * from cus_details cd, job_details jd, a a where a.jid=jd.id AND a.cid=cd.id AND jd.id='"+jid+"'";
             model.addRow(new Object[]{ename,jid, j_type,st_time ,fin_time });
        }
