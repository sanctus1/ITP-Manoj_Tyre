                            ...
                            if(L1Field.getText().matches("[0-9]*\\.?[0-9]+")){
                                ...
                                if(L2Field.getText().matches("[0-9]*\\.?[0-9]+")){
                                    ...
                                    if(L3Field.getText().matches("[0-9]*\\.?[0-9]+")){
                                            ...
                                            try {
                                                  String q = "INSERT INTO item (ItemCode,SerialNo,Description,ManufactName,SellingPri,BinID,PurchUnit,Image,SuplierPri,SupDiscount,CusDiscL1,CusDickL2,CusDiskL3,ExtDescription,CatCode) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
;
                            ...
                            if(CusDicL1FieldUpDe.getText().matches("[0-9]*\\.?[0-9]+")){
                                ...
                                if(CusDicL2FieldUpDe.getText().matches("[0-9]*\\.?[0-9]+")){
                                    ...
                                    if(CusDicL3FieldUpDe.getText().matches("[0-9]*\\.?[0-9]+")){
                                            ...
                                            try {
                                                String qNew = "UPDATE item SET ItemCode = ?,SerialNo = ?,Description = ?,ManufactName = ?,SellingPri = ? ,BinID = ?,PurchUnit = ?,Image = ?,SuplierPri = ?,SupDiscount = ?,CusDiscL1 = ?,CusDickL2 = ?,CusDiskL3 = ?,ExtDescription = ?,CatCode = ? Where ItemCode = ? ";
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        String catId = jTable2.getValueAt(row, 1).toString();
        String Desc = jTable2.getValueAt(row, 2).toString();
        String ReoLevel = jTable2.getValueAt(row, 3).toString();
        String RoQtty = jTable2.getValueAt(row, 4).toString();
        String BfStock = jTable2.getValueAt(row, 5).toString();
...
//                        int nB_Stock = Integer.parseInt(B_Stock);
                        ...
                        Float nRoLevel = Float.parseFloat(RoQty);
                        Float nRoQty = Float.parseFloat(RoLevel);
    ...
    private void SearchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SearchTableMouseClicked
        ...
        String getItemCat = SearchTable.getValueAt(row, 14).toString();
