 ...
 */
public class Inventory_User extends javax.swing.JFrame {
    Connection con = null;
...
//           }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Inventory_User.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//          BuyItCatField2.setText(getItemCat);
            RetailSalesHandling_User Rsha2 = new RetailSalesHandling_User();
            Rsha2.BuyItemCat.setText(getItemCat);
           Rsha2.tbiid.setText(getItmCode);
           Rsha2.tbup.setText(getSellPri);
           
          Rsha2.setVisible(true);
          Rsha2.Item_panel.setVisible(true);
          Search_panel.setVisible(false);
          Rsha2.DiscountCombo.addItem(getcustDiskL1);
          Rsha2.DiscountCombo.addItem(getcustDiskL2);
          Rsha2.DiscountCombo.addItem(getcustDiskL3);
          Rsha2.ItemId.setText(getItmCode);
          this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inventory_User.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Inventory_User().setVisible(true);
            }
        });
    }
